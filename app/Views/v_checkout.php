...
<div class="row">
    ...
    {
        $total_belanja = 25000000; // contoh dari keranjang
        $ongkir = 20000; // contoh ongkir tetap atau bisa diambil dari data lokasi

        // Hitung PPN 11%
        $ppn = $total_belanja * 0.11;

        // Hitung Biaya Admin berdasarkan total belanja
        if ($total_belanja <= 20000000) {
            $biaya_admin = $total_belanja * 0.006;
        } elseif ($total_belanja <= 40000000) {
            $biaya_admin = $total_belanja * 0.008;
        } else {
            $biaya_admin = $total_belanja * 0.01;
        }

        // Hitung Grand Total
        $grand_total = $total_belanja + $ongkir + $ppn + $biaya_admin;
